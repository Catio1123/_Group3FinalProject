...
public class GlobalService {
	...
	public static String USERID_SQLSERVER = "sa";
	
	public static String PASSWORD = "";
	public static String PASSWORD_MYSQL = "Do!ng123";
	public static String PASSWORD_SQLSERVER = "sa123456";
	...
	public static final String DB_URL_SQLSERVER = "jdbc:sqlserver://" + GlobalService.host + ":1433;databaseName=jspdb" ;
