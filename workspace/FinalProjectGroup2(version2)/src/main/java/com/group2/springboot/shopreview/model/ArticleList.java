...
public class ArticleList {
	...
	public ArticleList(float rate, String foodtype, String reviewtitle, String highlight, String url, String genre, String city, String name, Date postdate) {
		super();
		this.rate = rate;
