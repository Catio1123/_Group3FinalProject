...
public class AjaxCustomerController {
	...
	@PostMapping(value="/Ajax/member/checkduplicateaccount")
	...
	@PostMapping(value="/Ajax/member/checkduplicatecellphone")
	...
	@PostMapping(value="/Ajax/member/checkduplicateemail")
	...
	@PostMapping(value="/Ajax/member/checksamepassword")
