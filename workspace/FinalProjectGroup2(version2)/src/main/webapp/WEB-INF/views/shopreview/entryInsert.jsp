          ...
          <div class="col-12">
			...
			<div align="center">
				<fieldset style="width: 1000px;">
					...
					<tr>
						<td><form:label path="reviewtitle">食記標題:</form:label></td>
						<td><form:input id="addTitle" path="reviewtitle" type="text" size="100" placeholder="請輸入標題" />
					...
					<tr>
						<td><form:label path="highlight">食記簡介:</form:label></td>
						<td><form:input id="addHighlight" path="highlight" type="textarea" size="100" placeholder="請輸入簡介" />
						<span id='HighlightResult'></span>
						<p class="rule">(不可空白)</p>
						</td>
