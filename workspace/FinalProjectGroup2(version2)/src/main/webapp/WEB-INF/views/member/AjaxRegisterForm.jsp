...
// 		    var ugen = document.getElementsByName("gender")[0].value;
			...
			var url = "<c:url value='/member/ajaxregister.controller' />";
// 			 block, non-block
			//post=新增
			//open=傳到後端的方式，非同步
...
<tr>
    <td>姓名:</td>
    <td><input id="customerName" type="text" name="customerName" size="10" maxlength="10" placeholder="ex.Allen">
    </td>
</tr>
<tr>
    <td>帳號:</td>
...
<tr>
    <td>E-mail:</td>
    <td><input id="email" type="text" name="email" size="30" maxlength="20" placeholder="ex.pywang1982@hotmail.com">
    </td>
</tr>
<tr>
    <td>生日:</td>
