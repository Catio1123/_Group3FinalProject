...
window.onload = function() {
	...
	xhr.onreadystatechange = function() {
		if (xhr.readyState == 4 && xhr.status == 200) {
			...
			content += "<tr><th>編號</th><th>餐廳名稱</th><th>餐廳敘述</th><th>餐廳電話</th><th>餐廳地址</th><th>餐廳類別</th><th>刪除</th></tr></thead><tbody>";
			var members = JSON.parse(xhr.responseText);
			for(var i=0; i < members.length; i++){
				tmp = "<c:url value='/restaurantLists/' />";
			    content += 	"<tr><td width='70'>" + members[i].rid + "</td>" +
			                "<td align='center'>" + members[i].rname + "</td>" +
		        	       	"<td>" + members[i].rdes + "</td>" +
		            	   	"<td align='right'>" + members[i].rtel + "&nbsp;</td>" +
							"<td>" + members[i].radr + "</td>" +
							"<td>" + members[i].rsort + "</td>" +
							"<td><a href='#'>" + 
