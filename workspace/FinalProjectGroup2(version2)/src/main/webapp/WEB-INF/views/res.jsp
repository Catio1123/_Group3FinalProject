                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="${pageContext.request.contextPath}/templatemo_507_victory/img/breakfast_menu.jpg" alt="Breakfast">
                                </div>
                            </div>
                            <div class="col-md-7">
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="lunch-menu-content">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="${pageContext.request.contextPath}/templatemo_507_victory/img/lunch_menu.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="dinner-menu-content">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="${pageContext.request.contextPath}/templatemo_507_victory/img/dinner_menu.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <h2>Dinner Menu</h2>
