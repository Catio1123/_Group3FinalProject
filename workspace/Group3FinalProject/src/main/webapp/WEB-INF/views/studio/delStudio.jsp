							...
							<div id="content">
								<!-- Content -->
													<form id="studioForm">
														...
														<input type="text" id="studioName" name="name" disabled="disabled"/> <br /> 
														<label for="studiLocation">地點:</label>
														<input type="text" id="studioLocation" name="location" disabled="disabled"/> <br />
														<label for="studioFee">費用:</label>
														<input type="text" id="studioFee" name="fee" disabled="disabled"/> <br />
														
														
														<button type="button" id="btnDel">確認刪除</button>
