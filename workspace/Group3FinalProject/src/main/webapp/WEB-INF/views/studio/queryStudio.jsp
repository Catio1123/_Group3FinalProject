...
<body class="sb-nav-fixed">
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<!-- Navbar Brand-->
		<a class="navbar-brand ps-3" href="/ipodcast">ipodcast後臺管理</a>
		<!-- Sidebar Toggle-->
...
<!-- 					</ol> -->
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> 錄音室資料
						</div>
									...
									<thead>
										...
										<c:forEach var="studio" items="${studio}" >
											<tr>
												...
												<td><a href='<c:url value='/editStudio/${studio.id}'/>'>編輯</a>
												<a href='<c:url value='/delStudio/${studio.id}'/>'>刪除</a>
												</td>
