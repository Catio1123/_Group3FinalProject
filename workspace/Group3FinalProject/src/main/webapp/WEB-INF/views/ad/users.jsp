			...
			<main>
				<div class="container-fluid px-4">
					...
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item active">歡迎登入</li>
					</ol>
					<div class="row">
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> 合作廠商列表
						</div>
						<div class="card-body">
							<table id="datatablesSimple">
								<thead>
									...
									<c:forEach var="adDtos" items="${adDtos}">
										...
										<form:form action="/ipodcast/addRecord/${adDtos.ad.id}/${user.id}"
											method="post">
