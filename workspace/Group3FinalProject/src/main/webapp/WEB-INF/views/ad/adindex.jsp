...
<html lang="zh-tw">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="/ipodcast/wayne/creative/assets/favicon.ico" />
        <!-- Bootstrap Icons-->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<c:url value='/wayne/creative/assets/img/portfolio/thumbnails/3.jpg'/>" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="<c:url value='/wayne/creative/assets/img/portfolio/thumbnails/ad1.jpg'/>" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
