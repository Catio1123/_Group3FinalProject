...
<head>
    ...
    <link href="/ipodcast/wayne/sb2/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
...
<div class="card mb-4">
						...
						<div class="card-body">
							...
							<table id="datatablesSimple" style="border:3px #cccccc solid;"  rules="all";>
								<thead>
									<tr>
								...
								<tbody>
									<c:forEach var="ad" items="${ad}">
										<tr>
											...
											<td colspan=4><button style="background-color: #555555;
 color: white;
 border: none;
 font-size: 14px;
 border-radius: 4px;
 ...
 padding:5px 20px;"
												...
												<br>
											<br>
												<button style=" background-color: #ff6970;
 color: white;
 border: none;
 font-size: 14px;
 border-radius: 4px;
 ...
 padding:5px 20px;"
    ...
    <script src="/ipodcast/wayne/sb2/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="/ipodcast/wayne/sb2/vendor/jquery-easing/jquery.easing.min.js"></script>
