        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li class="d-lg-none"><a href="<c:url value='/forum/LoginPage'/>">Log In</a></li>
            </ul>
          </nav>
          
          <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
            <div class="ml-auto">
              <a href="<c:url value='/forum/AddPage'/>" class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-add"></span>Post a Comment</a>
              <a href="<c:url value='/forum/LoginPage'/>" class="btn btn-primary border-width-2 d-none d-lg-inline-block"><span class="mr-2 icon-lock_outline"></span>Log In</a>
            </div>
...
//     				 console.log(xhr0.responseText);
	    	 ...
	    	 function unpack(text){
	    		 ...
	    		 for(let i =0; i<forums.length;i++){
		    		 ...
		    		 segment += "<img src='"+"<c:url value='/ben/image/job_logo_1.jpg' /> "+"'";
