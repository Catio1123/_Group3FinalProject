		...
		<div id="header-wrapper">
			<header id="header" class="container">
				...
				<nav id="nav">
					...
					<ul>
					    <li><a href="<c:url value='/memberCentre' />">會員中心</a></li>
						<li><a href="<c:url value='/' />">Podcaster</a></li>
						<li><a href="<c:url value='/' />">資源共享</a></li>
						<li><a href="<c:url value='/' />">線下活動</a></li>
						<li><a href="<c:url value='/' />">廣告</a></li>
						<li><a href="<c:url value='/' />">論壇</a></li>
						<li><a href="<c:url value='/loginController' />">登入</a></li>
						<li>${Member.name}</li>
					</ul>
				</nav>
