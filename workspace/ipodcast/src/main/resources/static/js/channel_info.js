...
window.onload = function(){
    ...
    getChannelInfo.open('GET', `/ipodcast/logged/podcaster/${uid}/channel/${cid}`, true);
    ...
    btnUpdateChan.onclick=function(){
        ...
        xhr1.open('POST', "/ipodcast/files/channel/img", true);
        ...
        function updateChannel(){
          ...
          xhr2.open('PUT', `/ipodcast/logged/podcaster/${uid}/channel/${cid}`, false);
    ...
    btnDeleteChannel.onclick = function(){
        ...
        deleteChannel.open('DELETE', `/ipodcast/logged/podcaster/${uid}/channel/${cid}`, false)
