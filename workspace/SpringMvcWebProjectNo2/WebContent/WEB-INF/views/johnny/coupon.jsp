...
<form:form method="POST" action="updateCoupon" modelAttribute="coupon" commandName="coupon">
	<table>
		<tr>
...
<div align="center">
        ...
        <form:form action="<c:url value='/johnny/addCoupon'/>" method="post" modelAttribute="coupon" commandName="coupon">
