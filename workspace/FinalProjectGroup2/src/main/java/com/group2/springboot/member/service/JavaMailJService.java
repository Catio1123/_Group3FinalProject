...
//
//import com.map.j.login.dao.impl.CustomerUsersJDaoImpl;
//import com.map.j.login.function.RandomString;
//import com.map.j.login.model.CustomerUsersBean;
//
////@Service
...
//		String subject = "娛你同行，會員密碼忘記";
//		String customer = email;
//		CustomerUsersBean forgottonbean = (CustomerUsersBean)CUJDao.getCustomerUserByEmail(email);
//		
//		//////取得暫時密碼////////
...
//				+ "如果你沒有申請請忽略此郵件。<br>"
//				+ "您可以點及此連結前往網站首頁: <a href= http://localhost:8080/proj>點選這裡</a>";
//	
//				
//		
//		
//		//////更新成暫時密碼//////
//		
//		forgottonbean.setCustomerPassword(temppwd);
//		CUJDao.updateCustomerUser(forgottonbean);
//		
//		
//		/////////////////////////以下為寄送郵件的參數設定/////////////////////////////
...
//	
//	@Transactional
//	public void sendMailRegistration(CustomerUsersBean newbean) {
//		String subject = "娛你同行，會員帳號認證信";
//		String customer = newbean.getCustomerEmail();
...
//				+"親愛的使用者"+name+"您好，<br><br>很高興你加入我們娛你同行的一員。<br>"
