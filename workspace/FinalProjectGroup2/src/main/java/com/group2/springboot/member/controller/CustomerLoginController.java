...
//使用者登入後的controller
	...
	public String updateRestaurant(@ModelAttribute("CurrentUser") CustomerBean cusBean,
		...
		return "redirect:/member/updateuserinfo";  
