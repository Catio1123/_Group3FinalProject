...
window.onload = function() {
	...
	xhr.onreadystatechange = function() {
		if (xhr.readyState == 4 && xhr.status == 200) {
			...
			content += "<tr><th>編號</th><th>餐廳名稱</th><th>評分</th><th>城市</th><th>食物類型</th><th>餐廳類型</th></tr></thead><tbody>";
			...
			for(var i=0; i < members.length; i++){
			    ...
			    content += 	"<tr><td width='70'>" + members[i].id + "</td>" +
			                "<td align='center'>" + members[i].name + "</td>" +
		        	       	"<td>" + members[i].rate + "</td>" +
		            	   	"<td align='right'>" + members[i].city + "&nbsp;</td>" +
// 							"<td>" + members[i].url + "</td>" +
							"<td>" + members[i].foodtype + "</td>" +
							"<td>" + members[i].genre + "</td>" +
							"<td><a href='#'>" + 
