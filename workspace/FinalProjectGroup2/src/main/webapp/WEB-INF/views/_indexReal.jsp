...
<%-- 						<li><a href="<c:url value='/elena' />">${loginorout}</a></li> --%>
						<li id="logoutHref" style="visibility:hidden"><a href="<c:url value="/member/logout"/>">登出</a></li>
						<li id="myAccount" style="visibility:hidden"><a href="<c:url value="/member/gotoCustomerHomePage"/>">我的帳號</a></li>
						<li id="loginHref"><a href="<c:url value="/member"/>">登入</a></li>
