			...
			<div class="container">
				<div id="content">
					...
					<form id="studioForm">
						...
						<label for="studioId">編號:</label> <input type="text" id="studioId"
							name="id" disabled /> <br /> <br /> <label for="studioName">名稱:</label>
						<input type="text" id="studioName" name="name" /> <br /> <label
							for="studiLocation">地點:</label> <input type="text"
							id="studioLocation" name="location" /> <br /> <label
							for="studioFee">費用:</label> <input type="text" id="studioFee"
							name="fee" /> <br /> <label for="picture">照片:</label> <img
							width="300" hrught="300" id="studioPicture" name="picture">
