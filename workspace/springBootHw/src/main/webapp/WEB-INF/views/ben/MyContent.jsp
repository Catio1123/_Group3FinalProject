...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/IPodcast/css/ben/custom-bs.css">
    <link rel="stylesheet" href="/IPodcast/css/ben/jquery.fancybox.min.css">
    <link rel="stylesheet" href="/IPodcast/css/ben/bootstrap-select.min.css">
    <link rel="stylesheet" href="/IPodcast/css/ben/owl.carousel.min.css">
    <link rel="stylesheet" href="/IPodcast/css/ben/animate.min.css">

    <!-- MAIN CSS -->
    <link rel="stylesheet" href="/IPodcast/css/ben/style.css">    
  </head>
  <body id="top">
...
<div class="site-wrap">
    ...
    <!-- HOME -->
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('/IPodcast/images/ben/hero_1.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
          ...
          <div class="col-lg-8 mb-4 mb-lg-0">
            <div class="d-flex align-items-center">
              <div class="border p-2 d-inline-block mr-3 rounded">
                <img src="/IPodcast/images/ben/job_logo_5.jpg" alt="Image">
              </div>
              <div>
...
<!--               </div> -->
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="mb-5">
              <figure class="mb-5"><img src="/IPodcast/images/ben/job_single_img_1.jpg" alt="Image" class="img-fluid rounded"></figure>
...
<!--             </div> -->
            ...
            <div class="row mb-5">
              <div class="col-6">
                <a href="<c:url value='/toUpdate'/>" class="btn btn-block btn-primary btn-md"><span class="icon-heart-o mr-2 text-danger"></span>Update</a>
              </div>
              <div class="col-6">
...
<!--               <img src="/IPodcast/images/ben/job_logo_1.jpg" alt="Image" class="img-fluid"> -->
<!--             </div> -->
...
<!--             <a href="job-single.html"></a> -->
<!--             <div class="job-listing-logo"> -->
<!--               <img src="/IPodcast/images/ben/job_logo_2.jpg" alt="Image" class="img-fluid"> -->
<!--             </div> -->
...
<!--             <a href="job-single.html"></a> -->
<!--             <div class="job-listing-logo"> -->
<!--               <img src="/IPodcast/images/ben/job_logo_3.jpg" alt="Image" class="img-fluid"> -->
<!--             </div> -->
...
<!--             <a href="job-single.html"></a> -->
<!--             <div class="job-listing-logo"> -->
<!--               <img src="/IPodcast/images/ben/job_logo_4.jpg" alt="Image" class="img-fluid"> -->
<!--             </div> -->
...
<!--             <a href="job-single.html"></a> -->
<!--             <div class="job-listing-logo"> -->
<!--               <img src="/IPodcast/images/ben/job_logo_5.jpg" alt="Image" class="img-fluid"> -->
<!--             </div> -->
...
<!--         </ul> -->
    ...
    <section class="pt-5 bg-image overlay-primary fixed overlay" style="background-image: url('/IPodcast/images/ben/hero_1.jpg');">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 ml-auto align-self-end">
            <img src="/IPodcast/images/ben/apps.png" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- SCRIPTS -->
    <script src="/IPodcast/js/ben/jquery.min.js"></script>
    <script src="/IPodcast/js/ben/bootstrap.bundle.min.js"></script>
    <script src="/IPodcast/js/ben/isotope.pkgd.min.js"></script>
    <script src="/IPodcast/js/ben/stickyfill.min.js"></script>
    <script src="/IPodcast/js/ben/jquery.fancybox.min.js"></script>
    <script src="/IPodcast/js/ben/jquery.easing.1.3.js"></script>
    
    <script src="/IPodcast/js/ben/jquery.waypoints.min.js"></script>
    <script src="/IPodcast/js/ben/jquery.animateNumber.min.js"></script>
    <script src="/IPodcast/js/ben/owl.carousel.min.js"></script>
    
    <script src="/IPodcast/js/ben/bootstrap-select.min.js"></script>
    
    <script src="/IPodcast/js/ben/custom.js"></script>
    <script type="text/javascript">
    window.onload = function(){
    	let idd = ${fcontent.fid};
    	let todelete = document.getElementById("todelete");
    	todelete.action = "<c:url value='/toDelete/" + idd + "'/>";
