...
<div class="site-wrap">
    ...
    <!-- HOME -->
    <section class="home-section section-hero overlay bg-image" style="background-image: url('/IPodcast/images/ben/hero_1.jpg');" id="home-section">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 ml-auto align-self-end">
            <img src="<c:url value='/images/ben/apps.png'/> " alt="Free Website Template by Free-Template.co" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <script src="<c:url value='/js/ben/custom.js'/> "></script>
     ...
     <script type="text/javascript">
	     window.onload = function(){
	    	 ...
	    	 let url0 = "<c:url value='/getallcontent' />";
...
//     				 console.log(xhr0.responseText);
	    	 ...
	    	 searchbtn.onclick = function(){
	    		 ...
	    		 if(searchtxt.value != null){
	    			 ...
	    			 let url = "<c:url value='/search/" + searchtxt.value + "' />";
